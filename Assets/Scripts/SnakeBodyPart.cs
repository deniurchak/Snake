        ...
        switch (position.GetDirection())
        {
            ...
            case Snake.Direction.Up:
                switch (position.GetPreviousDirection())
                {
                    default:
                        angle = 0; break;
                    case Snake.Direction.Left: angle = 45; break;
                    case Snake.Direction.Right: angle = -45; break;
                }
                break;
            case Snake.Direction.Down:
                switch (position.GetPreviousDirection())
                {
                    default:
                        angle = 180; break;
                    case Snake.Direction.Left: angle = 180-45; break;
                    case Snake.Direction.Right: angle = 180+45; break;
                }
                break;
            case Snake.Direction.Left:
                switch (position.GetPreviousDirection())
                {
                    default:
                        angle = -90; break;
                    case Snake.Direction.Down: angle = -45; break;
                    case Snake.Direction.Up: angle = 45; break;
                }
                break;
